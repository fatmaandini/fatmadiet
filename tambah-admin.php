...
if(isset($_POST['submit'])):			
	...
	if(empty($errors)):
		$pass = sha1($password);
		$simpan = mysqli_query($koneksi,"INSERT INTO user (id_user, username, password, nama, email, role) VALUES ('', '$username', '$pass', '$nama', '$email', '1')");
		if($simpan) {
			redirect_to('list-admin.php?status=sukses-baru');		
		}else{
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="list-admin.php" class="btn btn-secondary btn-icon-split"><span class="icon text-white-50"><i class="fas fa-arrow-left"></i></span>
...
<form action="tambah-admin.php" method="post">
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-success"><i class="fas fa-fw fa-plus"></i> Tambah Data Admin</h6>
		</div>
		<div class="card-body">
			<div class="row">
