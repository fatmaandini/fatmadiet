...
if(isset($_POST['submit'])):
	...
	if(empty($errors)):
		...
		if($update) {
			redirect_to('list-admin.php?status=sukses-edit');
		}else{
...
<form action="edit-admin.php?id=<?php echo $id_user; ?>" method="post">
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-success"><i class="fas fa-fw fa-edit"></i> Edit Data Admin</h6>
		</div>
		<?php
		if(!$id_user) {
		?>
